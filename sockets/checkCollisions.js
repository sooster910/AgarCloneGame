...
/**
 * 
 * @param {object} pData : players'current location 
 * @param {*} pConfig : zoom and speed
 * @param {*} orbs  : going to loop through all orbs 
 * @param {*} settings : when we make new orb, we have to pass at the settings object
 */
...
//check if player has run into another player
